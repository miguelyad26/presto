...
public final class TableStatistics
{
    ...
    private final Estimate rowsCount;
    private final Map<String, ColumnStatistics> columnStatisticsMap;

    public TableStatistics(Estimate rowsCount, Map<String, ColumnStatistics> columnStatisticsMap)
    {
    ...
    {
        private Estimate rowsCount = unknownValue();
        private Map<String, ColumnStatistics> columnStatisticsMap = new HashMap<>();

        public Builder setRowsCount(Estimate rowsCount)
        {
