...
public class TestDetermineJoinDistributionType
{
    ...
    private final Session automaticChoiceSession;
    ...
    public TestDetermineJoinDistributionType()
    {
        ...
        automaticChoiceSession = Session.builder(queryRunner.getDefaultSession())
        ...
        partitionedJoinSession = Session.builder(queryRunner.getDefaultSession())
                .setSystemProperty(SystemSessionProperties.JOIN_DISTRIBUTION_TYPE, "partitioned")
                .build();
    ...
    public void testReplicatesSmallJoin()
    {
        ...
        assertPlan(automaticChoiceSession, sql, pattern);
    }

    @Test
    public void testPartitionsLargeJoin()
    {
        @Language("SQL") String sql = "select * from region join lineitem on region.regionkey = lineitem.orderkey";
