...
class ShowColumnStatsRewriteResultBuilder
{
    ...
    static List<Expression> buildStatisticsRows(TableStatistics tableStatistics, List<String> statisticsNames)
    {
        ...
        for (Map.Entry<ColumnHandle, ColumnStatistics> columnStats : tableStatistics.getColumnStatistics().entrySet()) {
            ...
            rowsBuilder.add(createStatsRow(Optional.of(columnStats.getKey().toString()), statisticsNames, columnStatisticsValues));
        }
