        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        public PlanNode visitJoin(JoinNode node, RewriteContext<Void> context)
        {
            ...
            boolean leftCountKnown = !leftStatistics.getOutputRowsCount().isValueUnknown();
            boolean rightCountKnown = !rightStatistics.getOutputRowsCount().isValueUnknown();
            double leftCount = leftStatistics.getOutputRowsCount().getValue();
            double rightCount = rightStatistics.getOutputRowsCount().getValue();

            boolean flipNeeded = (leftSizeKnown && rightSizeKnown && leftSize < rightSize)
                    || (leftCountKnown && rightCountKnown && leftCount < rightCount);
